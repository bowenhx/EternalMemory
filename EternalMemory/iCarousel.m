...
//    contentView.alpha = .5f;
    contentView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"carouselBg.png"]];
#ifdef __IPHONE_OS_VERSION_MAX_ALLOWED
...
{
    if ([delegate respondsToSelector:@selector(hideiCarousel)])
    {
        [delegate hideiCarousel];
    }
}
