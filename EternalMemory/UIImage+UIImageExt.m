...
- (UIImage *)scalingImageByRatio
{
    if (self.size.width < self.size.height) {
        ...
        if (img_w > SCREEN_WIDTH) {
            ...
            self = [self imageByScalingAndCroppingForSize:CGSizeMake(subImg_w, subImg_h)];
        } else {
            self = [self imageByScalingAndCroppingForSize:CGSizeMake(img_w, img_h)];
        }
    }
