...
@interface UseVideoViewController ()

@end

@implementation UseVideoViewController
...
- (void)viewDidLoad
{
    ...
    [backBtn setImage:[UIImage imageNamed:@"fc"] forState:UIControlStateNormal];
